...
Future<List<int>> generatePdfBytesllamadoatencion(
    LlamadoatencionModel llamadoatencion,
    List<UsuarioAprendizModel> aprendices,
    List<InstructorModel> responsables,
    List<ReglamentoModel> reglamentos) async {
        ...
        return pw.Container(
          ...
          child: pw.Column(
            ...
            children: [
                        ...
                        pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text('',
                                style: const pw.TextStyle(fontSize: 12)),
                            pw.Text(
                                'Fecha: ${llamadoatencion.fechallamadoatencion}',
                                style: const pw.TextStyle(fontSize: 12)),
                          ],
                        ),
                      ],
                        ...
                        pw.Padding(
                          ...
                          child: pw.Column(
                            ...
                            children: [
                              ...
                              pw.Text(
                                  'MOSQUERA , ${llamadoatencion.fechallamadoatencion}'),
                            ],
                          ),
                        ),
                        pw.Padding(
              ...
              pw.Text('DESARROLLO:',
                  style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
              pw.Text(llamadoatencion.descripcion),
              pw.SizedBox(height: 10),
              pw.Divider(),
              ...
              pw.Text('OBSERVACIONES:',
                  style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
              pw.Text(llamadoatencion.observaciones),
              pw.SizedBox(height: 10),
              pw.Divider(),
  ...
  // Convertir el PDF a bytes en memoria
